...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription('Performs a restart action on the selected server.')
    ...
    .addStringOption(option => option.setName('message').setDescription('Enter the restart message (security).').setRequired(true)),
  ...
  async execute(interaction) {
    try {
      ...
      const url = `https://api.nitrado.net/services/${identification}/gameservers/restart`;
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(`\`🟢\` \`System Success\`\nThe selected server has been restarted!\n\n**Announcement Message**\n\`${message}\``);
